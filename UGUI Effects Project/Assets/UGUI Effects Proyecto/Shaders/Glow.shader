Shader "MoonAntonio/Sprites/Glow"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 SampleSpriteTexture(float2 uv)
			{
				...
				// Obtener el color de una textura externa (caso de uso: apoyo alfa para ETC1 en android)
			...
			fixed4 ComputeFragment (v2f IN) : SV_Target
			{
				...
				// Si el contorno esta habilitado y hay un pixel, dibujar un contorno.
				if (_Outline > 0 && c.a != 0) 
				{
